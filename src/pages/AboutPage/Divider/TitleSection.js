    ...
    <section className="values-section">
      ...
      <div className="value-card">
        ...
        <p className="value-description">
          ...
          клиентах и партнерах как о своей семье, предоставляя лучшее качество
          услуг при каждом взаимодействии.
          <br />
          <br />
          <span className="highlighted">Ответственность и инновации:</span>{" "}
          Подвергай сомнению, бери ответственность, меняй и создавай будущее.
          <br />
          <br />
          <span className="highlighted">Поддержка и страсть:</span> Думай о том,
          что лучше для команды и делай это от души.
        </p>
      </div>
    </section>
  );
