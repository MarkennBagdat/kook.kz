  ...
  const faqData = [
    {
      ...
      answer: "kook — это платформа, соединяющая рестораны и поставщиков. Это решение, созданное нами с заботой о вашем времени и с целью упрощения вашего бизнеса. Наша миссия помогать вам легко и быстро взаимодействовать с поставщиками, чтобы обеспечить лучшее качество и цену товаров для вашей кухни и способствовать созданию вами кулинарных шедевров для ваших гостей."
    },
    {
      question: "Подключение к платформе для поставщиков платное?",
      answer: "Нет, подключение БЕСПЛАТНОЕ. Вы даже можете выставить все свои товары и получать заказы на 3F бесплатно. Если вы решите использовать 3F для управления заказами, настройкой интеграции, спец. прайсов и продвижений, мы индивидуально рассчитываем стоимость для вашей компании."
    },
    {
    ...
    {
      question: "Как kook обеспечивает безопасность и конфиденциальность данных?",
      answer: "Безопасность и конфиденциальность данных являются нашими главными приоритетами. Мы придерживаемся строгих стандартов защиты данных."
    }
