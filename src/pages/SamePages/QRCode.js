                ...
                {showQR ? (
                    ...
                    <div className="qr-wrapper">
                        ...
                        <div className="qr-section mobile-download-buttons">
                            ...
                            <a href="https://apps.apple.com/app/id" className="download-button app-store">
                                <img src={AppStoreIcon} alt="App Store" />
                                App Store
                            </a>
                            <a href="https://play.google.com/store/apps/details?id" className="download-button google-play">
