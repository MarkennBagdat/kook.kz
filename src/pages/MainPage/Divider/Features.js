...
import "./MainPage.css";
import CheckFilled from "./Picture/check_filled.svg"; // Make sure this svg is correctly imported
    ...
    <section className="features">
      <div className="features-content">
        ...
        <p className="main-description">
          3F — это торговая площадка, где отовики получают лучшие товары, а
          поставщики легко обрабатывают свои заказы
        </p>
